...
namespace KAP.Music
{
    public class MusicManager : MonoBehaviour
    {
        ...
        private IEnumerator NextAudioClip(AudioClip clip)
        {
        ...
        /// </summary>
        private void LoadToUI(Slider slider, float value, string mixerGroup)
        {
        ...
        /// </summary>
        private void NewValue(string mixerGroup, ref float oldValue, float newValue)
        {
        ...
        /// </summary>
        private void SetFloatMixer(string mixerGroup, float value) => mixer.audioMixer.SetFloat(mixerGroup, SaveFloatToVolume(value));

        private float SaveFloatToVolume(float value) => Mathf.Lerp(-80, 0, value);
        #endregion
